...
def helper() -> str:
    ...
    out.extend([
        ...
        "; HL starts at canonical NES OAM $C900. Four-byte records keep L aligned,\n",
        "; so L wrapping FC->00 is exactly the 64-entry terminator and frees B/C.\n",
        ...
        "    inc de\n",
        "\n",
        "    ; HL points at source X; low-byte wrap after slot 63 ends the scan.\n",
        "    inc l\n",
        "\n",
